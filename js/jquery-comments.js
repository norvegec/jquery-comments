...
if (!window.Object.keys) {
    window.Object.keys = function (obj) {
        var keys = [];
        for (var i in obj) {
...
if (!window.Object.create) {
    Object.create = function (o, properties) {
        if (typeof o !== 'object' && typeof o !== 'function') alert('Object prototype may only be an Object: ' + o);
        else if (o === null) alert("This browser's implementation of Object.create is a shim and doesn't support 'null' as the first argument.");
        if (typeof properties != 'undefined') alert("This browser's implementation of Object.create is a shim and doesn't support a second argument.");
        function F() { }
        F.prototype = o;
        return new F();
    };
...
(function ($) {
    ...
    var Comments = {
        ...
        render: function () {
            ...
            this.sortComments(mainLevelComments, 'newest')
        ...
        sortComments: function (comments, sortKey) {
            ...
            comments.sort(function(commentA, commentB) {
                ...
                return sortKey == 'newest' ? createdB - createdA : createdA - createdB;
            });
        },
